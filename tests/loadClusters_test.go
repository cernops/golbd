...
func getTestCluster(name string) lbcluster.LBCluster {
	...
	return lbcluster.LBCluster{Cluster_name: name,
		...
		Host_metric_table: map[string]lbcluster.Node{
			"lxplus132.cern.ch":               {Load: 100000, IPs: []net.IP{}},
			"lxplus041.cern.ch":               {Load: 100000, IPs: []net.IP{}},
			"lxplus130.cern.ch":               {Load: 100000, IPs: []net.IP{}},
			"lxplus133.subdo.cern.ch":         {Load: 100000, IPs: []net.IP{}},
			"monit-kafkax-17be060b0d.cern.ch": {Load: 100000, IPs: []net.IP{}}},
...
func getSecondTestCluster() lbcluster.LBCluster {
	...
	return lbcluster.LBCluster{Cluster_name: "test02.test.cern.ch",
		...
		Loadbalancing_password: "zzz123",
		Host_metric_table: map[string]lbcluster.Node{
			"lxplus013.cern.ch":      {Load: 100000, IPs: []net.IP{}},
			"lxplus038.cern.ch":      {Load: 100000, IPs: []net.IP{}},
			"lxplus039.test.cern.ch": {Load: 100000, IPs: []net.IP{}},
			"lxplus025.cern.ch":      {Load: 100000, IPs: []net.IP{}}},
...
func getHostsToCheck(c lbcluster.LBCluster) map[string]lbhost.LBHost {
	hostsToCheck := map[string]lbhost.LBHost{
		"lxplus132.cern.ch": {Cluster_name: c.Cluster_name,
			Host_name: "lxplus132.cern.ch",
			Host_transports: []lbhost.LBHostTransportResult{
				{Transport: "udp6", Response_int: 2, Response_string: "", IP: net.ParseIP("2001:1458:d00:2c::100:a6"), Response_error: ""},
				{Transport: "udp", Response_int: 2, Response_string: "", IP: net.ParseIP("188.184.108.98"), Response_error: ""},
			},
		...
		"lxplus041.cern.ch": {Cluster_name: c.Cluster_name,
			Host_name: "lxplus041.cern.ch",
			Host_transports: []lbhost.LBHostTransportResult{
				{Transport: "udp6", Response_int: 3, Response_string: "", IP: net.ParseIP("2001:1458:d00:32::100:51"), Response_error: ""},
				{Transport: "udp", Response_int: 3, Response_string: "", IP: net.ParseIP("188.184.116.81"), Response_error: ""},
			},
			Loadbalancing_username: c.Loadbalancing_username,
			Loadbalancing_password: c.Loadbalancing_password,
			LogFile:                c.Slog.TofilePath,
		...
		"lxplus130.cern.ch": {Cluster_name: c.Cluster_name,
			Host_name:              "lxplus130.cern.ch",
			Host_transports:        []lbhost.LBHostTransportResult{{Transport: "udp", Response_int: 27, Response_string: "", IP: net.ParseIP("188.184.108.100"), Response_error: ""}},
			Loadbalancing_username: c.Loadbalancing_username,
			Loadbalancing_password: c.Loadbalancing_password,
			LogFile:                c.Slog.TofilePath,
			Debugflag:              c.Slog.Debugflag,
		},
		"lxplus133.subdo.cern.ch": {Cluster_name: c.Cluster_name,
			Host_name:              "lxplus130.subdo.cern.ch",
			Host_transports:        []lbhost.LBHostTransportResult{{Transport: "udp", Response_int: 27, Response_string: "", IP: net.ParseIP("188.184.108.101"), Response_error: ""}},
			Loadbalancing_username: c.Loadbalancing_username,
			Loadbalancing_password: c.Loadbalancing_password,
			LogFile:                c.Slog.TofilePath,
			Debugflag:              c.Slog.Debugflag,
		},
		"monit-kafkax-17be060b0d.cern.ch": {Cluster_name: c.Cluster_name,
			Host_name:              "monit-kafkax-17be060b0d.cern.ch",
			Host_transports:        []lbhost.LBHostTransportResult{{Transport: "udp", Response_int: 100000, Response_string: "monit-kafkax.cern.ch=816,monit-kafka.cern.ch=816,test01.cern.ch=816", IP: net.ParseIP("188.184.108.100"), Response_error: ""}},
			Loadbalancing_username: c.Loadbalancing_username,
			Loadbalancing_password: c.Loadbalancing_password,
			LogFile:                c.Slog.TofilePath,
			Debugflag:              c.Slog.Debugflag,
...
func getBadHostsToCheck(c lbcluster.LBCluster) map[string]lbhost.LBHost {
	badHostsToCheck := map[string]lbhost.LBHost{
		...
		"lxplus133.subdo.cern.ch": {Cluster_name: c.Cluster_name,
			...
			Host_transports:        []lbhost.LBHostTransportResult{{Transport: "udp", Response_int: -15, Response_string: "", IP: net.ParseIP("188.184.108.101"), Response_error: ""}},
			Loadbalancing_username: c.Loadbalancing_username,
			Loadbalancing_password: c.Loadbalancing_password,
			LogFile:                c.Slog.TofilePath,
			Debugflag:              c.Slog.Debugflag,
...
func getHost(hostname string, responseInt int, responseString string) lbhost.LBHost {
	...
	return lbhost.LBHost{Cluster_name: "test01.cern.ch",
		Host_name: hostname,
		Host_transports: []lbhost.LBHostTransportResult{
			{Transport: "udp", Response_int: responseInt, Response_string: responseString, IP: net.ParseIP("188.184.108.98"), Response_error: ""}},
		Loadbalancing_username: "loadbalancing",
...
func TestLoadClusters(t *testing.T) {
	...
	config := lbconfig.Config{Master: "lbdxyz.cern.ch",
		...
		Parameters: map[string]lbcluster.Params{"test01.cern.ch": {Behaviour: "mindless", Best_hosts: 2,
			...
			"test02.test.cern.ch": {Behaviour: "mindless", Best_hosts: 10, External: false, Metric: "cmsfrontier", Polling_interval: 6, Statistics: "long"}}}
