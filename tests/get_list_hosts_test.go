...
func TestGetListHostsTwo(t *testing.T) {
	...
	clusters := []lbcluster.LBCluster{
		{Cluster_name: "test01.cern.ch",
			...
			Host_metric_table:      map[string]lbcluster.Node{"lxplus142.cern.ch": {}, "lxplus177.cern.ch": {}},
		...
		{Cluster_name: "test02.cern.ch",
			Loadbalancing_username: "loadbalancing",
			Loadbalancing_password: "zzz123",
			Host_metric_table:      map[string]lbcluster.Node{"lxplus013.cern.ch": {}, "lxplus177.cern.ch": {}, "lxplus025.cern.ch": {}},
	...
	expected := map[string]lbhost.LBHost{
		"lxplus142.cern.ch": {Cluster_name: "test01.cern.ch",
		...
		"lxplus177.cern.ch": {Cluster_name: "test01.cern.ch,test02.cern.ch",
		...
		"lxplus013.cern.ch": {Cluster_name: "test02.cern.ch",
		...
		"lxplus025.cern.ch": {Cluster_name: "test02.cern.ch",
